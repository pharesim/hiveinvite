...
$.ajax({
  url: "api/accept?id="+getParameterByName('inviteid'),
  type: "GET"
}).fail(function(){
...
var getAllKeys = function() {
  ...
  $("#postingWIF").text(privKeys['posting']);
  $("#activeWIF").text(privKeys['active']);
  $("#memoWIF").text(privKeys['memo']);
  $("#ownerWIF").text(privKeys['owner']);
}
...
$("#verifypassword").keyup(function(){
  if($(this).val() == passPhrase) {
    ...
    $("#finish_step3").prop('disabled',true);
  }
});
...
$("#finish").click(function(){
  $.ajax({
    ...
    type: "POST",
    data: {
      'id': getParameterByName('inviteid'),
      'account': newname,
